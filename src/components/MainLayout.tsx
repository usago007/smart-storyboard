  ...
  return (
    <div className="flex h-screen bg-slate-50">
          ...
          {navItems.map((item) => {
            ...
            return (
              <button
                ...
                className={`w-full flex items-center gap-3 px-4 h-10 rounded-[8px] text-sm transition-colors duration-150 ${
                  isActive
                    ? 'bg-gray-100 text-gray-900 font-semibold border-l-[3px] border-gray-900 rounded-l-none'
      ...
      <div className="flex-1 flex flex-col min-w-0">
        <header className="h-10 bg-white border-b border-gray-100 flex items-center gap-2 px-6">
          {current.icon && (
        ...
        <main className="flex-1 overflow-auto">
          <div className="max-w-[860px] mx-auto pt-5 px-6 pb-16">
            {children}
          </div>
        </main>
      </div>
